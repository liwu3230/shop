...
import {genSearchPresentList, useQuery} from '@/utils';
  ...
  const genSchema = (): SchemaObject => {
    const schema: SchemaObject = {
      ...
      body: {
        ...
        api: {
          method: 'post',
          url: `${BASE_ROUTE_PREFIX}/flowable/task/all`,
        ...
        filter: {
          ...
          controls: genSearchPresentList(3, [
            ...
            //   },
            //   value: locationQuery?.['userName'] || null,
            //   searchable: true,
            //   joinValues: false,
            //   clearable: true,
            // },
            {
              ...
              value: locationQuery?.['processDefKey'] || null,
              searchable: true,
              joinValues: false,
              clearable: true,
            },
          ...
          },
          {
            ...
            buttons: [
              ...
              // },
              {
                ...
                level: 'link',
                actionType: 'link',
                link: `${BASE_FRONT_ROUTE_PREFIX}/process/all/viewer?procInsId=$procInsId&procDefKey=$procDefKey`,
                blank: false,
              },
            ],
          },
