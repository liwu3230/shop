    ...
    const genSchema = (): SchemaObject => {
        const schema: SchemaObject = {
            ...
            body: {
                ...
                api: {
                    method: 'post',
                    url: `${BASE_ROUTE_PREFIX}/templateMessage/list`,
                ...
                headerToolbar: [
                    ...
                    },
                    {
                        ...
                        dialog: {
                            ...
                            body: {
                                ...
                                api: {
                                    url: `${BASE_ROUTE_PREFIX}/templateMessage/import`,
                                    method: 'post',
                                    // data: {
                                    //   '&': '$$',
                                    //   id: '$id',
                                ...
                                controls: [
                                    ...
                                    },
                                    {
                                        ...
                                        asBlob: true,
                                        drag: true,
                                        // receiver: `${BASE_ROUTE_PREFIX}/templateMessage/import`,
                                    }
                                ],
                            },
                        }
                    },
                    {
                        ...
                        api: {
                            method: 'post',
                            url: `${BASE_ROUTE_PREFIX}/templateMessage/export`,
                            adaptor: 'return {\n    ...payload,}',
                        },
                    },
                ],
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                dialog: {
                                    body: {
                                        type: 'form',
                                        api: `get:${BASE_ROUTE_PREFIX}/templateMessage/deleteById?id=$id`,
                                        controls: [
                                            {
                                                type: 'tpl',
                                                tpl: '您确认要删除吗？',
