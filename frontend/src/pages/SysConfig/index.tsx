    ...
    const genSchema = (): SchemaObject => {
        const schema: SchemaObject = {
            ...
            body: {
                ...
                api: {
                    method: 'post',
                    url: `${BASE_ROUTE_PREFIX}/sysConfig/list`,
                ...
                headerToolbar: [
                    ...
                    },
                    {
                        ...
                        dialog: {
                            ...
                            body: {
                                ...
                                reload: 'sysConfig',
                                api: {
                                    url: `${BASE_ROUTE_PREFIX}/sysConfig/import`,
                                    method: 'post',
                                    // data: {
                                    //   '&': '$$',
                                    //   id: '$id',
                                ...
                                controls: [
                                    ...
                                    },
                                    {
                                        ...
                                        asBlob: true,
                                        drag: true,
                                        // receiver: `${BASE_ROUTE_PREFIX}/sysConfig/import`,
                                    }
                                ],
                            },
                        }
                    },
                    {
                        ...
                        api: {
                            method: 'post',
                            url: `${BASE_ROUTE_PREFIX}/sysConfig/export`,
                            adaptor: 'return {\n    ...payload,}',
                        },
                    },
                ],
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                dialog: {
                                    body: {
                                        type: 'form',
                                        api: `get:${BASE_ROUTE_PREFIX}/sysConfig/deleteById?id=$id`,
                                        controls: [
                                            {
                                                type: 'tpl',
                                                tpl: '您确认要删除吗？',
