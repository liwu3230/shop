    ...
    const genSchema = (): SchemaObject => {
        const schema: SchemaObject = {
            ...
            body: {
                ...
                api: {
                    method: 'post',
                    url: `${BASE_ROUTE_PREFIX}/examConfig/list`,
                ...
                headerToolbar: [
                    ...
                    },
                    {
                        ...
                        dialog: {
                            ...
                            body: {
                                ...
                                reload: 'examConfig',
                                api: {
                                    url: `${BASE_ROUTE_PREFIX}/examConfig/import`,
                                    method: 'post',
                                    // data: {
                                    //   '&': '$$',
                                    //   id: '$id',
                                ...
                                controls: [
                                    ...
                                    },
                                    {
                                        ...
                                        asBlob: true,
                                        drag: true,
                                        // receiver: `${BASE_ROUTE_PREFIX}/examConfig/import`,
                                    }
                                ],
                            },
                        }
                    },
                    {
                        ...
                        api: {
                            method: 'post',
                            url: `${BASE_ROUTE_PREFIX}/examConfig/export`,
                            adaptor: 'return {\n    ...payload,}',
                        },
                    },
                ],
