  ...
  const genSchema = (): SchemaObject => {
    const schema: SchemaObject = {
      ...
      body: {
        ...
        api: {
          method: 'post',
          url: `${BASE_ROUTE_PREFIX}/taskTag/list`,
        ...
        headerToolbar: [
          ...
          //             reload: 'taskTag',
          //             api: {
          //                 url: `${BASE_ROUTE_PREFIX}/taskTag/import`,
          //                 method: 'post',
          //                 // data: {
          //                 //   '&': '$$',
          //                 //   id: '$id',
          ...
          //                     asBlob: true,
          //                     drag: true,
          //                     // receiver: `${BASE_ROUTE_PREFIX}/taskTag/import`,
          //                 }
          //             ],
          //         },
          //     }
          ...
          //     api: {
          //         method: 'post',
          //         url: `${BASE_ROUTE_PREFIX}/taskTag/export`,
          //         adaptor: 'return {\n    ...payload,}',
          //     },
          // },
        ],
            ...
            buttons: [
              ...
              },
              {
                ...
                dialog: {
                  body: {
                    type: 'form',
                    api: `get:${BASE_ROUTE_PREFIX}/taskTag/deleteById?id=$id`,
                    controls: [
                      {
                        type: 'tpl',
                        tpl: '您确认要删除吗？',
