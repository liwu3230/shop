...
import org.example.backend.common.primary.entity.SysRoleMenuExample.Criteria;
import org.example.backend.common.primary.entity.SysRoleMenuExample.Criterion;
...
public class SysRoleMenuSqlProvider {
    ...
    public String insertSelective(SysRoleMenuKey record) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysRoleMenuKey record = (SysRoleMenuKey) parameter.get("record");
