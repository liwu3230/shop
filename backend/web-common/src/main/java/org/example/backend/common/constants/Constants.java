...
public class Constants {
    ...
    //上传类型
    public static final String UPLOAD_TYPE_IMAGE = "qm_image";
...
//    public static final String CONFIG_KEY_PUBLIC_LOGO = "wechat_avatar"; //公众号logo
    ...
    public static final Integer GROUP_DATA_ID_INDEX_INDEX_TYPE = 74; //首页分类
    ...
    //首页Banner图片
    public static final int INDEX_RECOMMEND_BANNER = 1; //优选推荐
    public static final int INDEX_HOT_BANNER = 2; //热门推荐
    ...
    public static final int INDEX_GOOD_BANNER = 5; //首页推荐
    ...
    public static String RESULT_VERIFICATION_NOTAUTH = "你没有核销码 ${vCode} 的订单的核销权限";
