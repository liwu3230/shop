...
import org.example.backend.common.primary.entity.SysUserRoleExample.Criteria;
import org.example.backend.common.primary.entity.SysUserRoleExample.Criterion;
...
public class SysUserRoleSqlProvider {
    ...
    public String insertSelective(SysUserRoleKey record) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysUserRoleKey record = (SysUserRoleKey) parameter.get("record");
