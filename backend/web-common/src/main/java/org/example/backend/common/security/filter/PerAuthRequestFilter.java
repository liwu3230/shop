...
import org.example.backend.common.security.service.ClientDetailsSecurityService;
...
public class PerAuthRequestFilter extends OncePerRequestFilter {
    ...
    @Resource
    private ClientDetailsSecurityService clientDetailsSecurityService;
    @Resource
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(token)) {
                ...
                } else if (tokenType == TokenType.API) {
                    userDetails = clientDetailsSecurityService.loadUserByUsername(userName);
                } else {
                    throw new AuthException("token is illegal");
                }
            }
            if (T.isNull(userDetails)) {
                throw new AuthException("not find SecurityUserDetails!");
            }
